    ...
    return (
        <div className="flex flex-col gap-4 bg-zinc-900/50 p-6 rounded-[24px] border border-zinc-800/80 max-w-7xl mx-auto mb-10">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    ...
                    <Select selectedKey={selectedType} onSelectionChange={(key) => setSelectedType(key)}>
                        ...
                        <Select.Popover className="bg-zinc-800 border border-zinc-700 rounded-xl shadow-xl mt-1 overflow-hidden z-50">
                            <ListBox className="p-1">
                                <ListBox.Item id="all" className="flex items-center justify-between text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize"><span>All Types</span></ListBox.Item>
                                <ListBox.Item id="full-time" className="flex items-center justify-between text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize"><span>Full-time</span></ListBox.Item>
                                <ListBox.Item id="part-time" className="flex items-center justify-between text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize"><span>Part-time</span></ListBox.Item>
                                <ListBox.Item id="contract" className="flex items-center justify-between text-zinc-200 hover:bg-purple-600 hover:text-white rounded-lg px-3 py-2 text-sm cursor-pointer capitalize"><span>Contract</span></ListBox.Item>
                            </ListBox>
                        </Select.Popover>
                    </Select>
                </div>

                {/* 3. Category - Span 3 columns */}
                <div className="md:col-span-3">
                ...
                {/* 4. Remote + Reset - Span 1 column */}
                <div className="md:col-span-1 flex flex-col items-center justify-start md:justify-center gap-3 h-10 pb-1">
